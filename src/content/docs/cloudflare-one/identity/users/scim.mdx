...
While the native integration is pending, a workaround is possible. You can connect to the Google Workspace API, pull user and group data, and then send it to the Cloudflare SCIM endpoint.
:::
