...
<Tabs syncKey="dashNewNav"> 
	<TabItem label="Old dashboard">
      ...
      3. Apply filters and select **Create custom rule** to create a [custom rule](/waf/custom-rules/create-dashboard/) based on those filters.
  ...
  <TabItem label="New dashboard" icon="rocket">
      ...
      3. Apply filters and select **Create custom security rule** to create a custom rule based on your filters. 
